...
const ScrollGallery = () => {
  ...
  const yLarge = useTransform(scrollYProgress, [0, 1], ["0%", "-300%"]);
  ...
  return (
    <div className="relative w-full min-h-[400vh]">
      ...
      <div className="fixed left-[10%] top-1/2 transform -translate-y-1/2 w-[326px] h-[326px] overflow-hidden shadow-lg">
        <motion.div className="relative w-full h-full" style={{ y: ySmall }}>
          {smallImages.reverse().map((src, i) => (
            <div
              key={i}
